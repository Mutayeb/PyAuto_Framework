...
def create_auth_request(username,password):
        ...
        return response
@pytest.mark.parametrize("user_cred",read_credentials_from_excel("C:/Users/mutay/OneDrive/Documents/courses/PyATB/code files/pyProject1-AutomationFramework/tests/test/datadriventesting/testdata_ddt.xlsx"))
